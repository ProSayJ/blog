...
package cn.prosayj.blog.manage.oss.service.impl;
...
import cn.prosayj.blog.core.config.CloudStorageConfig;
...
public class QiniuCloudStorageServiceImpl extends CloudStorageService {
    ...
    public String upload(byte[] data, String path) {
        try {
            ...
            throw new BussinessException(ErrorEnum.OSS_CONFIG_ERROR);
        }
